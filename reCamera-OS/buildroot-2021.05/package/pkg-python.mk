...
# Target distutils-based packages (legacy, aliased to setuptools)
...
PKG_PYTHON_DISTUTILS_DEPENDENCIES = \
	$(PKG_PYTHON_SETUPTOOLS_DEPENDENCIES)

# Host distutils-based packages (legacy, aliased to setuptools)
...
ifneq ($$(filter-out distutils setuptools setuptools-rust pep517 flit flit-bootstrap hatch maturin poetry,$$($(2)_SETUP_TYPE)),)
$$(error "Invalid $(2)_SETUP_TYPE. Valid options are 'distutils', 'maturin', 'setuptools', 'setuptools-rust', 'pep517', 'flit', 'hatch' or 'poetry'.")
endif
